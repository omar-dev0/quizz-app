...
class _ApiServices implements ApiServices {
  ...
  @override
  Future<ExamQuestionsReponseModel> getExamQuestionsByExamId(
    String token,
    String id,
  ) async {
    final _extra = <String, dynamic>{};
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ExamQuestionsReponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ExamQuestionsReponseModel _value;
    try {
      _value = ExamQuestionsReponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<ExamByIdResponseModel> getExamById(
    String token,
    String id,
  ) async {
    final _extra = <String, dynamic>{};
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ExamByIdResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ExamByIdResponseModel _value;
    try {
      _value = ExamByIdResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
