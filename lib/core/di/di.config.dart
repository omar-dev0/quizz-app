...
import '../../feature/auth/data/data_source/impl/auth_online_data_source_impl.dart'
    as _i15;
import '../../feature/auth/data/repository/auth_repository_impl.dart' as _i17;
import '../../feature/auth/domain/repository/auth_repository.dart' as _i16;
import '../../feature/auth/domain/use_cases/forget_password_use_case.dart'
    as _i18;
import '../../feature/auth/domain/use_cases/login_use_case.dart' as _i20;
import '../../feature/auth/domain/use_cases/logout_use_case.dart' as _i22;
...
import '../../feature/exam/data/data_sources/online_data_source/online_data_source_impl.dart'
    as _i25;
import '../../feature/exam/data/repositories/exam_by_id_repo_impl.dart' as _i28;
import '../../feature/exam/data/repositories/exam_questions_repo_impl.dart'
    as _i30;
import '../../feature/exam/data/repositories/exam_repo_impl.dart' as _i32;
import '../../feature/exam/data/repositories/home_repo_impl.dart' as _i34;
import '../../feature/exam/data/repositories/logout_repo_impl.dart' as _i36;
import '../../feature/exam/domain/repositories/exam_by_id_repo.dart' as _i27;
import '../../feature/exam/domain/repositories/exam_repo.dart' as _i31;
import '../../feature/exam/domain/repositories/exams_quesions_repo.dart'
    as _i29;
import '../../feature/exam/domain/repositories/home_repo.dart' as _i33;
import '../../feature/exam/domain/repositories/logout_repo.dart' as _i35;
import '../../feature/exam/domain/use_cases/logout_use_case.dart' as _i37;
import '../../feature/exam/domain/use_cases/usecases.dart' as _i38;
...
import '../../feature/exam/presentation/manager/subject_exam_manager/exams_view_model.dart'
    as _i40;
import '../dio/dio_provider.dart' as _i45;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i18.ForgetPasswordUseCase>(
        () => _i18.ForgetPasswordUseCase(gh<_i16.AuthRepository>()));
    gh.factory<_i19.ForgetPasswordViewModel>(
        () => _i19.ForgetPasswordViewModel(gh<_i18.ForgetPasswordUseCase>()));
    gh.factory<_i20.LoginUseCase>(
        () => _i20.LoginUseCase(gh<_i16.AuthRepository>()));
    gh.factory<_i21.LoginViewModel>(
        () => _i21.LoginViewModel(gh<_i20.LoginUseCase>()));
    gh.factory<_i22.LogoutUseCase>(
        () => _i22.LogoutUseCase(gh<_i16.AuthRepository>()));
    ...
    gh.factory<_i27.ExamByIdRepo>(() => _i28.ExamByIdRepoImpl(
          gh<_i24.OnlineDataSource>(),
          gh<_i7.OfflineDataSource>(),
        ));
    gh.factory<_i29.ExamQuestionsRepo>(() => _i30.ExamQuestionsRepoImpl(
          gh<_i24.OnlineDataSource>(),
          gh<_i7.OfflineDataSource>(),
        ));
    gh.factory<_i31.ExamRepo>(() => _i32.ExamRepoImpl(
          gh<_i24.OnlineDataSource>(),
          gh<_i7.OfflineDataSource>(),
        ));
    gh.factory<_i33.HomeRepo>(() => _i34.HomeRepoImpl(
          gh<_i24.OnlineDataSource>(),
          gh<_i7.OfflineDataSource>(),
        ));
    gh.factory<_i35.LogoutRepo>(
        () => _i36.LogoutRepoImpl(gh<_i24.OnlineDataSource>()));
    gh.factory<_i37.LogoutUseCase>(
        () => _i37.LogoutUseCase(gh<_i35.LogoutRepo>()));
    gh.factory<_i38.UseCases>(() => _i38.UseCases(
          gh<_i33.HomeRepo>(),
          gh<_i31.ExamRepo>(),
          gh<_i29.ExamQuestionsRepo>(),
          gh<_i27.ExamByIdRepo>(),
        ));
    gh.factory<_i39.ExamStartScreenViewModel>(
        () => _i39.ExamStartScreenViewModel(gh<_i38.UseCases>()));
    gh.factory<_i40.ExamsViewModel>(
        () => _i40.ExamsViewModel(gh<_i38.UseCases>()));
    gh.factory<_i41.HomeViewModel>(
        () => _i41.HomeViewModel(gh<_i38.UseCases>()));
    gh.factory<_i42.ResultScreenViewModel>(
        () => _i42.ResultScreenViewModel(gh<_i38.UseCases>()));
    gh.singleton<_i43.ActionHandler>(() => _i43.ActionHandler(
          gh<_i38.UseCases>(),
          gh<_i41.HomeViewModel>(),
        ));
    gh.singleton<_i44.ExamsScreenActionHandler>(
        () => _i44.ExamsScreenActionHandler(
              gh<_i40.ExamsViewModel>(),
              gh<_i38.UseCases>(),
            ));
    return this;
  }
