...
import '../../feature/auth/presentation/update_password/view_model/change_password_viewmodel.dart'
    as _i5;
import '../../feature/exam/data/apis/api_services.dart' as _i11;
...
import '../../feature/exam/domain/use_cases/usecase.dart' as _i25;
...
import '../../feature/exam/presentation/manager/subject_exam_manager/exams_view_model.dart'
    as _i26;
import '../dio/dio_provider.dart' as _i30;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i11.ApiServices>(() => _i11.ApiServices(gh<_i6.Dio>()));
    gh.singleton<_i12.ApiServices>(() => _i12.ApiServices(gh<_i6.Dio>()));
    gh.factory<_i3.AuthOnlineDataSource>(
        () => _i13.AuthOnlineDataSourceImpl(gh<_i12.ApiServices>()));
    ...
    gh.factory<_i20.OnlineDataSource>(
        () => _i21.OnlineDataSourceImpl(gh<_i11.ApiServices>()));
    ...
    gh.factory<_i25.UseCase>(() => _i25.UseCase(gh<_i23.HomeRepo>()));
    gh.factory<_i26.ExamsViewModel>(
        () => _i26.ExamsViewModel(gh<_i25.UseCase>()));
    gh.factory<_i27.HomeViewModel>(
        () => _i27.HomeViewModel(gh<_i25.UseCase>()));
    gh.singleton<_i28.ActionHandler>(() => _i28.ActionHandler(
          gh<_i25.UseCase>(),
          gh<_i27.HomeViewModel>(),
        ));
    gh.singleton<_i29.ExamsScreenActionHandler>(
        () => _i29.ExamsScreenActionHandler(
              gh<_i26.ExamsViewModel>(),
              gh<_i25.UseCase>(),
            ));
    return this;
  }
