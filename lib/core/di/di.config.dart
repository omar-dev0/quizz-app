...
import '../../feature/exam/domain/use_cases/usecases.dart' as _i40;
...
import '../../feature/exam/presentation/manager/subject_exam_manager/exams_view_model.dart'
    as _i42;
import '../dio/dio_provider.dart' as _i47;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i27.UpdatePasswordUseCase>(
        () => _i27.UpdatePasswordUseCase(gh<_i16.AuthRepository>()));
    ...
    gh.factory<_i36.LogoutRepo>(
        () => _i37.LogoutRepoImpl(gh<_i24.OnlineDataSource>()));
    gh.factory<_i38.LogoutUseCase>(
        () => _i38.LogoutUseCase(gh<_i36.LogoutRepo>()));
    gh.factory<_i39.ResetPasswordViewModel>(
        () => _i39.ResetPasswordViewModel(gh<_i27.UpdatePasswordUseCase>()));
    gh.factory<_i40.UseCases>(() => _i40.UseCases(
          gh<_i34.HomeRepo>(),
          gh<_i32.ExamRepo>(),
          gh<_i30.ExamQuestionsRepo>(),
          gh<_i28.ExamByIdRepo>(),
        ));
    gh.factory<_i41.ExamStartScreenViewModel>(
        () => _i41.ExamStartScreenViewModel(gh<_i40.UseCases>()));
    gh.factory<_i42.ExamsViewModel>(
        () => _i42.ExamsViewModel(gh<_i40.UseCases>()));
    gh.factory<_i43.HomeViewModel>(
        () => _i43.HomeViewModel(gh<_i40.UseCases>()));
    gh.factory<_i44.ResultScreenViewModel>(
        () => _i44.ResultScreenViewModel(gh<_i40.UseCases>()));
    gh.singleton<_i45.ActionHandler>(() => _i45.ActionHandler(
          gh<_i40.UseCases>(),
          gh<_i43.HomeViewModel>(),
        ));
    gh.singleton<_i46.ExamsScreenActionHandler>(
        () => _i46.ExamsScreenActionHandler(
              gh<_i42.ExamsViewModel>(),
              gh<_i40.UseCases>(),
            ));
    return this;
  }
