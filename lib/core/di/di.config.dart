...
import '../../feature/exam/domain/use_cases/usecases.dart' as _i35;
...
import '../../feature/exam/presentation/manager/subject_exam_manager/exams_view_model.dart'
    as _i37;
import '../dio/dio_provider.dart' as _i42;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i35.UseCases>(() => _i35.UseCases(
          gh<_i33.HomeRepo>(),
          gh<_i31.ExamRepo>(),
          gh<_i29.ExamQuestionsRepo>(),
          gh<_i27.ExamByIdRepo>(),
        ));
    gh.factory<_i36.ExamStartScreenViewModel>(
        () => _i36.ExamStartScreenViewModel(gh<_i35.UseCases>()));
    gh.factory<_i37.ExamsViewModel>(
        () => _i37.ExamsViewModel(gh<_i35.UseCases>()));
    gh.factory<_i38.HomeViewModel>(
        () => _i38.HomeViewModel(gh<_i35.UseCases>()));
    gh.factory<_i39.ResultScreenViewModel>(
        () => _i39.ResultScreenViewModel(gh<_i35.UseCases>()));
    gh.singleton<_i40.ActionHandler>(() => _i40.ActionHandler(
          gh<_i35.UseCases>(),
          gh<_i38.HomeViewModel>(),
        ));
    gh.singleton<_i41.ExamsScreenActionHandler>(
        () => _i41.ExamsScreenActionHandler(
              gh<_i37.ExamsViewModel>(),
              gh<_i35.UseCases>(),
            ));
    return this;
  }
