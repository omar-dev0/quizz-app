...
import '../../feature/exam/data/core/dio_provider.dart' as _i22;
...
import '../../feature/exam/data/repositories/exam_questions_repo_impl.dart'
    as _i11;
import '../../feature/exam/data/repositories/exam_repo_impl.dart' as _i13;
import '../../feature/exam/data/repositories/home_repo_impl.dart' as _i15;
import '../../feature/exam/domain/repositories/exam_repo.dart' as _i12;
import '../../feature/exam/domain/repositories/exams_quesions_repo.dart'
    as _i10;
import '../../feature/exam/domain/repositories/home_repo.dart' as _i14;
import '../../feature/exam/domain/use_cases/usecases.dart' as _i16;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i10.ExamQuestionsRepo>(() => _i11.ExamQuestionsRepoImpl(
          gh<_i8.OnlineDataSource>(),
          gh<_i4.OfflineDataSource>(),
        ));
    gh.factory<_i12.ExamRepo>(() => _i13.ExamRepoImpl(
          gh<_i8.OnlineDataSource>(),
          gh<_i4.OfflineDataSource>(),
        ));
    gh.factory<_i14.HomeRepo>(() => _i15.HomeRepoImpl(
          gh<_i8.OnlineDataSource>(),
          gh<_i4.OfflineDataSource>(),
        ));
    gh.factory<_i16.UseCases>(() => _i16.UseCases(
          gh<_i14.HomeRepo>(),
          gh<_i12.ExamRepo>(),
          gh<_i10.ExamQuestionsRepo>(),
        ));
    gh.factory<_i17.ExamStartScreenViewModel>(
        () => _i17.ExamStartScreenViewModel(gh<_i16.UseCases>()));
    gh.factory<_i18.ExamsViewModel>(
        () => _i18.ExamsViewModel(gh<_i16.UseCases>()));
    gh.factory<_i19.HomeViewModel>(
        () => _i19.HomeViewModel(gh<_i16.UseCases>()));
    gh.singleton<_i20.ActionHandler>(() => _i20.ActionHandler(
          gh<_i16.UseCases>(),
          gh<_i19.HomeViewModel>(),
        ));
    gh.singleton<_i21.ExamsScreenActionHandler>(
        () => _i21.ExamsScreenActionHandler(
              gh<_i18.ExamsViewModel>(),
              gh<_i16.UseCases>(),
            ));
    return this;
  }
