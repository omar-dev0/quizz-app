...
import '../../feature/exam/data/repositories/exam_questions_repo_impl.dart'
    as _i25;
import '../../feature/exam/data/repositories/exam_repo_impl.dart' as _i27;
import '../../feature/exam/data/repositories/home_repo_impl.dart' as _i29;
import '../../feature/exam/domain/repositories/exam_repo.dart' as _i26;
import '../../feature/exam/domain/repositories/exams_quesions_repo.dart'
    as _i24;
import '../../feature/exam/domain/repositories/home_repo.dart' as _i28;
import '../../feature/exam/domain/use_cases/usecases.dart' as _i30;
...
import '../../feature/exam/presentation/manager/subject_exam_manager/exams_view_model.dart'
    as _i32;
import '../dio/dio_provider.dart' as _i36;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i24.ExamQuestionsRepo>(() => _i25.ExamQuestionsRepoImpl(
          gh<_i21.OnlineDataSource>(),
          gh<_i7.OfflineDataSource>(),
        ));
    gh.factory<_i26.ExamRepo>(() => _i27.ExamRepoImpl(
          gh<_i21.OnlineDataSource>(),
          gh<_i7.OfflineDataSource>(),
        ));
    ...
    gh.factory<_i30.UseCases>(() => _i30.UseCases(
          gh<_i28.HomeRepo>(),
          gh<_i26.ExamRepo>(),
          gh<_i24.ExamQuestionsRepo>(),
        ));
    gh.factory<_i31.ExamStartScreenViewModel>(
        () => _i31.ExamStartScreenViewModel(gh<_i30.UseCases>()));
    gh.factory<_i32.ExamsViewModel>(
        () => _i32.ExamsViewModel(gh<_i30.UseCases>()));
    gh.factory<_i33.HomeViewModel>(
        () => _i33.HomeViewModel(gh<_i30.UseCases>()));
    gh.singleton<_i34.ActionHandler>(() => _i34.ActionHandler(
          gh<_i30.UseCases>(),
          gh<_i33.HomeViewModel>(),
        ));
    gh.singleton<_i35.ExamsScreenActionHandler>(
        () => _i35.ExamsScreenActionHandler(
              gh<_i32.ExamsViewModel>(),
              gh<_i30.UseCases>(),
            ));
    return this;
  }
...
class _$DioProvider extends _i36.DioProvider {}
